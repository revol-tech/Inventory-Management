...
public class LaborWork extends JPanel {
	...
	public LaborWork() {
		...
		gbc_labourname.fill = GridBagConstraints.HORIZONTAL;
		gbc_labourname.insets = new Insets(0, 0, 5, 5);
		gbc_labourname.gridx = 1;
		gbc_labourname.gridy = 0;
		labourname.setFont(new Font("Dialog", Font.BOLD, 12));
		labourname.setMaximumRowCount(1);
		...
		labourname.setEditor(new ComboBoxEditor());
	...
	private void initGUI() {
		...
		comboBoxLaborType.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent arg0) {
				String name = comboBoxLaborType.getSelectedItem().toString();
				if (name == "Bokenya") {
					patheri.setVisible(false);
					madhesi.setVisible(false);
