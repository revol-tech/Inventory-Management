...
public class ToolBarUtils {
	...
	public JLabel setJLabel(JLabel lbl, int sLeft, int sTop, int sWidth,
			int sHeight, boolean setBool) {
	...
	public JTextField setJTextField(JTextField txtfield, int sLeft, int sTop,
	...
	public JMenuItem setJMenuItem(JMenuItem mnuitem, String sCaption,
			String imgLocation) {
	...
	public JTabbedPane setJTabbedPane(JTabbedPane setTabbed, String setTitle,
			String setIcon, JPanel setPanel, int sLeft, int sTop, int sWidth,
			int sHeight) {
	...
	public JButton CreateJToolbarButton(String srcToolTipText,
